...
// REMOVE WEBSITE FIELD FROM COMMENTS SECTION
...
function my_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'youatemyrice' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your sidebar.', 'youatemyrice' ),
	...
	register_sidebar( array(
		'name'          => __( 'Footer 1', 'youatemyrice' ),
		'id'            => 'sidebar-2',
		'description'   => __( 'Add widgets here to appear in your footer.', 'youatemyrice' ),
		'before_widget' => '<section id="%1$s" class="widget %2$s">',
		'after_widget'  => '</section>',
		'before_title'  => '<h3 class="widget-title">',
		'after_title'   => '</h3>',
...
add_action( 'wp_enqueue_scripts', 'youatemyrice_scripts' );

// ADD GOOGLE FONTS

function youatemyrice_google_fonts() {
...
add_action('wp_print_styles', 'youatemyrice_google_fonts');